          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/50 border border-black/5 rounded-xl focus:outline-none focus:border-black focus:bg-white transition-all text-sm font-medium text-gray-900 placeholder:text-gray-400"
