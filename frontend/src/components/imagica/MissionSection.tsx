          ...
          <div className="preview-panel p-6">
            <div className="bg-white/70 rounded-xl border border-[#eee] p-4 shadow-sm w-full min-h-[280px]">
              <div className="flex items-center gap-3 mb-4 text-[11px] text-[#999]">
                <span className="px-2 py-1 rounded bg-[#f0f0f0]">LeaveTracker</span>
              </div>
              <div className="flex gap-3">
                <div className="flex-1 space-y-3">
                  <div className="text-[11px] text-[#999]">User Input</div>
                  <div className="bg-white rounded-lg border border-[#eee] p-3">
                    <div className="text-[10px] text-[#bbb]">I need to track team leaves and holidays...</div>
                  </div>
                  <div className="bg-white rounded-lg border border-[#eee] p-3">
                    <div className="text-[10px] text-[#bbb]">Create an app that tracks PTO and sick leaves</div>
                    <button className="mt-2 px-3 py-1 rounded-full bg-[#4488ff] text-white text-[9px]">Use</button>
                  </div>
                </div>
                <div className="w-[130px] shrink-0">
                  <div className="bg-gradient-to-b from-[#111] to-[#333] rounded-2xl p-3 text-white shadow-lg">
                    <div className="text-[10px] font-semibold mb-1">Welcome</div>
                    <div className="text-[8px] opacity-80 mb-2">to Leave Tracker</div>
                    <div className="text-[7px] opacity-70 mb-2">This app tracks employee time-off and approvals.</div>
